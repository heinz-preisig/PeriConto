...
from PeriConto_commander import *
from PeriConto_commander import OntoBuilderCommander
...
class OntobuilderUI(QMainWindow, OntoBuilderCommander):
  def __init__(self):
    OntoBuilderCommander.__init__(self)
    super(OntobuilderUI, self).__init__()
    self.ui = Ui_MainWindow()
    self.ui.setupUi(self)


    self.commander = OntoBuilderCommander(self)
